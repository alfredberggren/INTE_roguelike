...
public class EquipmentTest {
    ...
    public void testEquipmentName() {
        Equipment e = new Equipment("test", DEFAULT_EQUIPMENT_ACTIONS, Equipment.Effect.DAMAGE, 10, new PhysicalAbility("Arrow",4,1));
    ...
    public void testConstructorWithValidParametersShouldSucceed() {
        Equipment e = new Equipment("Sword", DEFAULT_EQUIPMENT_ACTIONS, Equipment.Effect.DAMAGE, 10, new PhysicalAbility("MegaSword",4,1));
    ...
    public void testSettingPosition() {
        ...
        Equipment equipment = new Equipment("Test Equipment", DEFAULT_EQUIPMENT_ACTIONS, Equipment.Effect.HEALTH, 100, new MagicAbility("Test Magic Ability", 5, 1,"Magic",1,1));
    ...
    public void testEquipmentEffect() {
        Equipment e = new Equipment("test", DEFAULT_EQUIPMENT_ACTIONS, Equipment.Effect.DAMAGE, 100, new PhysicalAbility("MiniSword",2,1));
    ...
    public void testPossibleActions() {
        Equipment e = new Equipment("test", DEFAULT_EQUIPMENT_ACTIONS, Equipment.Effect.HEALTH, 100, new PhysicalAbility("MegaSword",40,1));
    ...
    public void testEquipmentHaveMagicAbility() {
        Equipment e = new Equipment("test", DEFAULT_EQUIPMENT_ACTIONS, Equipment.Effect.HEALTH, 100, new MagicAbility("IceBall", 5,1,"Shoots ice",1,2));
    ...
    public void testDamageModified() {
        Equipment e = new Equipment("test", DEFAULT_EQUIPMENT_ACTIONS, Equipment.Effect.DAMAGE, 50, new MagicAbility("Fireball", 30,1,"Shoots fire",2,1));
        e.damageModifier(60);
   ...
   @Test
    ...
    public void testTwoUnequalEquipmentsHaveUnequalHashCode(){
        assertNotEquals(new Equipment("Dagger", DEFAULT_EQUIPMENT_ACTIONS, Equipment.Effect.DAMAGE, 100, new PhysicalAbility("Dagger",5,1)).hashCode(), new Equipment("Sword", DEFAULT_EQUIPMENT_ACTIONS, Equipment.Effect.HEALTH, 50, new MagicAbility("FireBall",10,1,"Shoots fire",2,1)).hashCode());
    }
    @Test
    @DisplayName("Two equipments which are unequal")
    public void testTwoUnequalEquipments() {
        assertNotEquals(new Equipment("Dagger", DEFAULT_EQUIPMENT_ACTIONS, Equipment.Effect.DAMAGE, 100, new PhysicalAbility("Dagger",5,1)), new Equipment("Sword", DEFAULT_EQUIPMENT_ACTIONS, Equipment.Effect.HEALTH, 100, new MagicAbility("IceBall", 5,1,"Shoots ice",2,1)));
    }
    @Test
    ...
    public void testTwoEquipmentsWithSameParametersHaveSameHashCode(){
        assertEquals(new Equipment("Dagger", DEFAULT_EQUIPMENT_ACTIONS, Equipment.Effect.DAMAGE, 100, new PhysicalAbility("Dagger",5,1)).hashCode(), new Equipment("Dagger", DEFAULT_EQUIPMENT_ACTIONS, Equipment.Effect.DAMAGE, 100, new PhysicalAbility("Dagger",5,1)).hashCode());
    }
