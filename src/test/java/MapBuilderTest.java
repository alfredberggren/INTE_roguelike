...
public class MapBuilderTest {
    ...
    private static final Equipment TEST_EQUIPMENT = new Equipment("Stone Sword", EquipmentSlot.RIGHT_HAND, Equipment.Effect.DAMAGE, 10, new PhysicalAbility("Swipe", 10,1, "Test"));
