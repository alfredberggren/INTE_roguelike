...
public class InteractableTest {
    ...
    public void testNPCHasCorrectActions() {
        ...
        Interactable i1 = new NPC("Fido", 10, 100,10, possibleInteractableActions);
    ...
    public void testEquipmentHasCorrectActions() {
        ...
        Interactable i1 = new Equipment("Steel Sword", possibleInteractableActions, Equipment.Effect.HEALTH, 0, new PhysicalAbility("SuperArrow",15,"Physical"));
        assertEquals(possibleInteractableActions, i1.getPossibleActions());
    }
    ...
    public void testTwoNPCsWithSameNameAreEqual() {
        assertEquals(new NPC("test123", 10, 10, 10, DEFAULT_INTERACTABLE_ACTIONS), new NPC("test123", 13, 23,10, DEFAULT_INTERACTABLE_ACTIONS));
    }

    @Test
    @DisplayName("Två NPC:s med samma namn ska ha samma hashCode")
    public void testTwoNPCsWithSameNameShouldHaveSameHashCode() {
        assertEquals(new NPC("test123", 10, 10, 10,DEFAULT_INTERACTABLE_ACTIONS).hashCode(), new NPC("test123", 13, 23,10, DEFAULT_INTERACTABLE_ACTIONS).hashCode());
    }

    @Test
    @DisplayName("Två NPCs som är olika")
    public void testTwoUnequalNPCs() {
        assertNotEquals(new NPC("test1234", 10, 10, 10,DEFAULT_INTERACTABLE_ACTIONS), new NPC("test123", 13, 23,10, DEFAULT_INTERACTABLE_ACTIONS));
    }

    @Test
    @DisplayName("Två olika NPCs har olika hashCode")
    public void testTwoUnequalNPCsShouldHaveUnequalHashCodes() {
        assertNotEquals(new NPC("test1234", 10, 10, 10,DEFAULT_INTERACTABLE_ACTIONS).hashCode(), new NPC("test123", 13, 23,10, DEFAULT_INTERACTABLE_ACTIONS).hashCode());
    }
}
